...
para usar este aplicativo no expo snack basta importar estes arquivos na plataforma, primeiro baixe os arquivos dentro da pasta "projeto-3", depois no expo snack, crie um snack se você ainda não tiver feito, clique nos 3 pontos a direita da aba "project" e clique em "import files" e jogue os arquivos baixados lá
